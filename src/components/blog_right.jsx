...
const RightSidebar = () => (
  <div className="col-xs-24 col-sm-6 sidebar right-slidebar">
      ...
      <div className="article-content col-md-24">
        <div className="article-content-inner">
          <div>
            ...
            <h4><Link to="/article-right">{title}</Link></h4>
          </div>
          <div className="blogs-image">
            <ul className="list-inline">
              <li><Link to="/article-right"><img src="/assets/images/demo_870x580.png" alt="" /></Link></li>
            </ul>
          </div>
          <div className="intro">
            {intro}
  ...
  <div id="col-main" className="blog blog-page col-xs-24 col-sm-18 col-content">
    <div className="blog-content-wrapper">
      <BlogPostMain
        ...
        title="Sample blog post with right sidebar"
      ...
      <div className="container">
        <div className="row">
          <div id="page-header" className="col-md-24">
            <h1 id="page-title">Blog With Right Sidebar</h1>
          </div>
          <BlogRightContent />
          <RightSidebar />
        </div>
