...
const Sidebar = () => (
  <div id="sidebar" className="col-sm-6 col-md-6">
    <div className="filter-group">
      <h4>Filter</h4>
      <ul>
        <li><Link to="/collection?size=S">Size: S</Link></li>
        <li><Link to="/collection?size=M">Size: M</Link></li>
        <li><Link to="/collection?size=L">Size: L</Link></li>
        <li><Link to="/collection?size=XL">Size: XL</Link></li>
      </ul>
    </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-18 col-md-18">
            <h1>Collection Right Sidebar</h1>
...
export default CollectionRightPage;
